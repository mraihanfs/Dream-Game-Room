...
if (isset($_SESSION['nameAD'])) {
    $gd = mysqli_query($konek, "SELECT * FROM operator");
    $repeat = 0;
} else {
        ...
        <nav class="navbar navbar-dark bg-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item" role="presentation"><a class="nav-link text-md-light active" href="panel_ad_operator.php"><i class="fas fa-users-cog"></i><span>Operator</span></a>
                    </li>
                    <li class="nav-item" role="presentation"><a class="nav-link text-md-light " href="panel_ad_user.php"><i class="fas fa-users"></i><span>User</span></a></li>
                </ul>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold ">Operator Info
                                <div class="text-md-right">
                                    <!--button tambah Operator-->
                                    <button type="button" class="btn btn-primary  btn-sm" type="submit" data-toggle="modal" data-target="#myModaladd">Add
                                        Operator</button>
                                </div>
                            </p>
                            <!--pop up pendaftaran Operator-->
                                    ...
                                    <div class="modal-content">
                                        <form action="Save.php" method="POST">
                                            ...
                                            <div class="modal-header">
                                                <h4 class="modal-title">From Daftar Operator</h4>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col">
                                                        <div class="form-group"><label for="password"><strong>Password</strong></label><input class="form-control" type="password" placeholder="password" name="password"></div>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group"><label for="Nama"><strong>Nama</strong></label><input class="form-control" type="text" placeholder="Nama" name="Nama"></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="form-group"><label for="Nik"><strong>Nik</strong></label><input class="form-control" type="number" placeholder="Nik" name="Nik"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- footer modal -->
                                            <div class="modal-footer">
                                                <div class="col4">
                                                    <button type="submit" class="btn btn-primary submit btn-sm">Tambah
                                                        Operator</button>
                                                </div>
                                            </div>
                                        </form>
                                ...
                                <table class="table dataTable my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        <?php while ($data = mysqli_fetch_assoc($gd)) { ?>
                                            <tr>
                                                <td><img class="rounded-circle mr-2" width="30" height="30" src="../assets/img/iconorg.png"><?php echo $data['username'] ?></td>
                                                <td><?php echo $data['nama'] ?></td>
                                                <td> <?php echo $data['NIK'] ?></td>
                                                <!--button edit + pop upnya -->
                                                <td>
                                                    <button type="button" class="btn btn-primary  btn-sm" type="submit" data-toggle="modal" data-target="#myModaledit<?php echo $repeat?>">Edit</button>
                                                    <!--pop up Edit  Operator-->
                                                    <div id="myModaledit<?php echo $repeat?>" class="modal fade " role="dialog">
                                                        <div class="modal-dialog">
                                                            <!-- konten modal-->
                                                            <div class="modal-content">
                                                                <!-- heading modal -->
                                                                ...
                                                                <form action="EditSave.php" method="POST">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="form-group"><label for="Nik"><strong>Identitas<br></strong> <?php echo $data['NIK'] ?></label>
                                                                                <div class="form-row">
                                                                                    <div class="col">
                                                                                        <div class="form-group"><label for="Username"><strong>Username</strong></label><input class="form-control" type="text" placeholder="Username" name="Username" value="<?php echo $data['username'] ?>">
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <div class="col4">
                                                                                <button type="submit" class="btn btn-primary submit btn-sm" name="submit" value="OP:edit:<?php echo $data['NIK'] ?>">Perbarui
                                                                                    Data</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-primary  btn-sm" type="submit" data-toggle="modal" data-target="#myModalhapus<?php echo $repeat?>">Hapus !</button>
                                                    <!--pop up Hapus  Operator-->
                                                    <div id="myModalhapus<?php echo $repeat?>" class="modal fade " role="dialog">
                                                        <div class="modal-dialog">
                                                            <!-- konten modal-->
                                                            <div class="modal-content">
                                                                <!-- heading modal -->
